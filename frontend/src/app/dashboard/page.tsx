    ...
    >
      <div className="space-y-6">
        <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">
          <strong className="font-semibold">โหมดตัวอย่างข้อมูล:</strong>{' '}
          ตัวเลขในหน้านี้ยังเป็นข้อมูลจำลองสำหรับตรวจ UI โปรดเชื่อมต่อ API
          ก่อนใช้เป็นตัวเลขปฏิบัติการจริง
        </div>
